...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo "  --out_dir_h OUT_DIR_H         Horizontal output directory (default: /mnt/whliao/ocr_out_h)"
            echo "  --out_dir_v OUT_DIR_V         Vertical output directory (default: /mnt/whliao/ocr_out_v)"
...
echo "     python3 convert_to_lmdb.py --src /mnt/whliao/ocr_out_h --dst out_h.lmdb"
echo "     python3 convert_to_lmdb.py --src /mnt/whliao/ocr_out_v --dst out_v.lmdb"
echo ""
echo "  2. Transfer LMDB files to NFS:"
echo "     rsync -a out_h.lmdb out_v.lmdb /mnt/whliao/lmdb/"
echo ""
echo "  3. (Optional) Clean up local images:"
echo "     rm -rf /mnt/whliao/ocr_out_h /mnt/whliao/ocr_out_v"
echo ""
