#!/bin/bash
# Single batch runner for lines2.txt - for manual execution to avoid CPU timeout
...
# Configuration
# ============================================================
LINES_FILE="lines2.txt"
FONTS_DIR="fonts"
BGS_DIR="backgrounds"
OUT_DIR_H="output/ocr_out2_h"
OUT_DIR_V="output/ocr_out2_v"
...
# ============================================================
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║         Single Batch OCR Synthesis Runner (Lines2)            ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
echo "Configuration:"
...
# ============================================================
START_TIME=$(date +%s)
LOGFILE="logs/batch2_${ORIENTATION}_${START_LINE}_${END_LINE}_$(date +%Y%m%d_%H%M%S).log"
mkdir -p logs
